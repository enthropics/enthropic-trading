...
-- Password: system-internal-only (never expose)
INSERT INTO accounts (
    ...
    '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.VTtYA/4YBkYhJC',
...
INSERT INTO accounts (
    ...
    '$2a$12$rQEqBN.y1vHGQA/XKWZF.OXhXrKpX4SuPdqXpY9nQb8Wm/6BwKZmG',
...
INSERT INTO accounts (
    ...
    '$2a$12$pHwEPpJDqGGGD.QG/vPGHuXUJLp5FGNNqQWvX8bMwQPk8.RLBxKWi',
...
INSERT INTO accounts (
    ...
    '$2a$12$8nZ.c8KjMqZkGPpX4hV5oeJvJQnQK.cPxN8wYZpB7hD3RZbf9YZWK',
...
INSERT INTO accounts (
    ...
    '$2a$12$kLHBYqq8j/HXwZ.Yv3gONeNYdJQGKgvPZUP9lBPHcVGz7WYzKZaHe',
    'a0000000-0000-0000-0000-000000000004',
    true, true, 0.00000000, 0.00000000
) ON CONFLICT (username) DO NOTHING;

DO $$ BEGIN RAISE NOTICE 'Seed data loaded successfully'; END $$;
